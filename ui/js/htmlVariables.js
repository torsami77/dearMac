const signUpForm = `
	...
	<input onclick="phoneApp();" type="tel" id="phone" placeholder="Mobile Number" class="form-text-field" /><br/>
	</span>
	<input type="text" placeholder="First Name" class="form-text-field"/>
	<input type="text" placeholder="Last Name" class="form-text-field" /><br/>
