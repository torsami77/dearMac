          ...
          <table class="email-content" width="100%" cellpadding="0" cellspacing="0" role="presentation">
                  ...
                  <tr>
                    <td class="content-cell">
                      ...
                      <p><strong>Hi, ${first_name}</strong></p>
                        <p>We're excited to have you get started. First, you need to confirm your account and create password. Just press the button below.</p>
           ...
           https://litmus.com/blog/a-guide-to-bulletproof-buttons-in-email-design -->
                              <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
                                <tr>
                                  <td align="center" >
                                    <a href="${link}" class="f-fallback button" target="_blank"><font color="white">Confirm Your Account</font></a>
                                  </td>
                                </tr>
                              </table>
                            </td>
                        ...
                        <p>If you did not signup on our platform, please ignore this email or <a href="mailto:hello@dearmac.com">contact support</a> if you have questions.</p>
                        <p>Thanks,
                          <br>DearMac Team</p>
